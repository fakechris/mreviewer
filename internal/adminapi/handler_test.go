...
func (f fakeSnapshotService) Runs(_ context.Context, _ RunFilters) (RunsSnapshot, error) {
	return f.runs, nil
}
...
func (f fakeSnapshotService) IdentityMappings(_ context.Context, _ IdentityFilters) (IdentityMappingsSnapshot, error) {
