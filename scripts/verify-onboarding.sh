...
require_pattern "README.md" "^## What Your First Result Actually Is" "README.md must explain the first review result"
require_pattern "README.md" "^## Get Your First Review In 5 Minutes" "README.md must document the first-review quick start"
...
require_pattern "README.md" "docs/assets/readme/rendered/mreviewer-first-review-demo.gif" "README.md must embed the first-review demo asset"
require_pattern "README.md" "docs/assets/readme/rendered/mreviewer-github-inline-real-2.png" "README.md must embed a real inline review screenshot"
require_pattern "README.zh-CN.md" "^## 第一次结果到底是什么" "README.zh-CN.md must explain the first review result"
require_pattern "README.zh-CN.md" "^## 5 分钟拿到第一份 Review" "README.zh-CN.md must document the first-review quick start"
...
require_pattern "README.zh-CN.md" "docs/assets/readme/rendered/mreviewer-first-review-demo.gif" "README.zh-CN.md must embed the first-review demo asset"

# Enterprise docs must still describe Docker/webhook/admin deployment.
require_pattern "README.md" "^## Enterprise Webhook Quick Start" "README.md must document the enterprise webhook path"
...
require_pattern "README.zh-CN.md" "^## 企业 Webhook 快速启动" "README.zh-CN.md must document the enterprise webhook path"
...
require_pattern ".github/workflows/release.yml" "RELEASE_PR_TOKEN" "release workflow must support a dedicated formula PR token"
...
require_pattern ".github/workflows/ci.yml" "^  workflow_dispatch:$" "CI workflow must support manual dispatch for formula sync PRs"
