...
func renderPersonalConfig(provider string) (string, error) {
	...
	return fmt.Sprintf(`# Personal CLI config generated by mreviewer init.
...
llm:
  ...
  routes:
    %s:
      ...
      %s
      %s
`, defaultPersonalPort, chosen.RouteName, chosen.RouteName, chosen.RouteName, chosen.Provider, chosen.BaseURL, chosen.APIKeyEnv, chosen.Model, chosen.Output, chosen.Tokens, chosen.Reasoning), nil
}
